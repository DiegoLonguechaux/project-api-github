export default function Card({ data }) {
    console.log(data);
    return (
        <div className="bg-white rounded-lg shadow-2xl p-6 gap-6">
            <div className="flex items-center gap-6 mb-2">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-500">Joined {data.created_at && new Date(data.created_at).toLocaleDateString()}</p>
                </div>
            </div>
            <p className="my-4">{data.bio || "Not available"}</p>
            <div className="flex justify-between bg-slate-200 rounded-lg px-4 py-2 my-6">
                <div>
                    <p>Public repos</p>
            ...
            <div className="grid grid-cols-2 gap-y-2 gap-x-6 my-6">
